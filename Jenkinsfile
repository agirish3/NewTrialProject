pipeline {
    ...
    stages {
        ...
        stage('IOS'){
          steps{
            xcodeBuild appURL: '', assetPackManifestURL: '', buildDir: '', buildIpa: true, bundleID: '', bundleIDInfoPlistPath: '', cfBundleShortVersionStringValue: '', cfBundleVersionValue: '', compileBitcode: false, configuration: 'Debug', developmentTeamID: '3MJ2EZ38UC', developmentTeamName: '', displayImageURL: '', fullSizeImageURL: '', ipaExportMethod: 'development', ipaName: '${BASE_NAME} ${SHORT_VERSION} ${BUILD_DATE}', ipaOutputDirectory: '', keychainName: '', keychainPath: '', keychainPwd: '', logfileOutputDirectory: '', provisioningProfiles: [[provisioningProfileAppId: 'com.sampleJenkinsApp', provisioningProfileUUID: '8c0750c1-cdb6-417e-87ed-5f8adc4bc764']], sdk: '', signingMethod: 'readFromProject', symRoot: '', target: '', thinning: '', uploadBitcode: false, xcodeProjectFile: '', xcodeProjectPath: '', xcodeSchema: 'MyApp', xcodeWorkspaceFile: '', xcodebuildArguments: ''
