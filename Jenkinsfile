pipeline {
    ...
    stages {
        ...
        stage('IOS'){
          steps{
            xcodeBuild appURL: '', assetPackManifestURL: '', buildDir: '', buildIpa: true, bundleID: '', bundleIDInfoPlistPath: '', cfBundleShortVersionStringValue: '', cfBundleVersionValue: '', compileBitcode: false, configuration: 'Debug', developmentTeamID: '9Q7ES27ZH2', developmentTeamName: '', displayImageURL: '', fullSizeImageURL: '', ipaExportMethod: 'development', ipaName: '${BASE_NAME} ${SHORT_VERSION} ${BUILD_DATE}', ipaOutputDirectory: '', keychainName: '', keychainPath: '', keychainPwd: '', logfileOutputDirectory: '', provisioningProfiles: [[provisioningProfileAppId: 'com.sampleJenkinsApp', provisioningProfileUUID: '8c0750c1-cdb6-417e-87ed-5f8adc4bc764']], sdk: '', signingMethod: 'automatic', symRoot: '', target: '', thinning: '', uploadBitcode: false, xcodeProjectFile: '', xcodeProjectPath: '', xcodeSchema: 'MyApp', xcodeWorkspaceFile: '/Users/Shared/Jenkins/Home/workspace/IonicTestingTrial_master-WGZRVFEGY6QS4UEY6H7NFXZ7WPHYHCGMU7UKQT5YJIK5RIUXN2SQ/platforms/ios/MyApp', xcodebuildArguments: ''
